...
class Url_Polls_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $url_polls       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->url_polls, plugin_dir_url( __FILE__ ) . 'css/url-polls-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->url_polls, plugin_dir_url( __FILE__ ) . 'js/url-polls-public.js', array( 'jquery' ), $this->version, false );
